    ...
    >
      <article className="mx-auto max-w-2xl">
        <div className="space-y-9 text-base leading-8 text-foreground-soft sm:space-y-10 sm:text-lg sm:leading-9">
          ...
          <p>
            I mimo tego stażu dalej czasem daję się nabrać na czułe słówka. Bo one działają, nawet
            kiedy wiesz, jak to się skończy.
          </p>
          ...
          <blockquote className="my-2 border-l-2 border-fuchsia-500 pl-6 font-display text-2xl italic leading-snug text-foreground sm:pl-8 sm:text-3xl">
          ...
          <p>Serducho rośnie, prawda?</p>
          <p>
            No i wtedy pojawia się pierwsza czerwona flaga. Widzę ją, oczywiście, że widzę, ale
            ignoruję. Bo przecież jest tak miło.
          </p>

          <div className="my-2 space-y-4 rounded-2xl border border-fuchsia-100 bg-white/60 px-7 py-7 font-display text-lg italic leading-relaxed text-foreground sm:px-9 sm:py-8 sm:text-xl">
          ...
          <p>„Chociaż na chwilę”. Klasyk.</p>
          <p>Nikt jeszcze nie zaczął toksycznego związku, myśląc, że to na stałe.</p>
          <p>I ja, kobieta z doświadczeniem, czasami mięknę.</p>
          <p>Dobrze. Spróbujmy. Cena z kosmosu, ale przecież „tylko spróbujemy”.</p>
          <p>
          ...
          <p>
            ...
            kompromisie boli jak rozstanie. Mnie też.
          </p>
          <p>Bo znowu zaczynam od zera, a czas płynie.</p>
          ...
          <div className="space-y-3 border-t border-fuchsia-100 pt-9">
            <p className="font-display text-xl text-foreground sm:text-2xl">A Wam zdarzyły się takie relacje?</p>
            <p className="font-display text-xl text-foreground sm:text-2xl">Macie swoje „chociaż na próbę i na chwilę”?</p>
          </div>
        </div>

        <div className="mt-14 flex items-center gap-3 border-t border-border pt-6">
